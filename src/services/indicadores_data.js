export let data = [
  {
    ...
    grupo: "3",
    is_indicador: true,
    exemplo: "Foram cobertas 100 fêmeas durante a estação de monta. Dessas, apenas 57 geraram produtos. Logo, o índice de natalidade foi de 57%.",
    conceito:
...

  {
    ...
    grupo: "3", // Zootecnicos
    is_indicador: true,
    exemplo: "Foram cobertas 100 fêmeas na estação de monta. Após diagnóstico de gestação, constatou-se que 76 delas estavam prenhes. Logo, o índice de fertilidade é de 76%.",
    conceito:
  ...
  },
  {
    ...
    grupo: "3", // Zootecnicos
    is_indicador: true,
    exemplo: "Em uma propriedade rural nasceram 57 bezerros, 120 dias depois, somente 56 bezerros foram desmamados. Logo, o índice de desmame foi de 98%.",
    conceito:
...

  {
    ...
    grupo: "3", // Zootecnicos
    is_indicador: true,
    exemplo: "Levando-se em conta que os animais que morreram em determinado período perfazem um total de 5 U.A. e o rebanho possui um total de 268.5 U.A., o índice de mortalidade é de 1.8%.",
    conceito:
...

  {
    ...
    grupo: "3", // Zootecnicos
    is_indicador: true,
    exemplo: "Sobre o total do rebanho foram descartados animais que equivalem a 6.1 U.A.. Como o rebanho total é de 268.5 .U.A., o índice de descarte foi de 2.27%.",
    conceito:
...

  {
    ...
    grupo: "3", // Zootecnicos
    is_indicador: true,
    exemplo: "Um determinado animal, após abatido, gerou uma carcaça de 235kg. Seu peso vivo era de 460kg. Logo, seu rendimento de carcaça foi de 51%.",
    conceito:
...

  {
    ...
    grupo: "1", //Economicos
    is_indicador: true,
    exemplo: "Em um determinado rebanho de corte foram abatido animais equivalentes a 80 U.A.. O rebanho total, antes dos abates, era de 268.5 U.A., ou seja, houve um desfrute de 29.8%.  ",
    conceito:
      "TAXA DE DESFRUTE – apresenta a capacidade de rebanho em gerar excedentes para venda.",
    formula1: "(totalabatido*100)/rebanhototal",
    formula:
      "Taxa de Desfrute = nº total de abatidos x 100 / nº rebanho total",
    formula_equacao: [
      {
        label: "Total abatido",
        name: "totalabatido",
...

  {
    ...
    grupo: "2", //Globais
    is_indicador: true,
    exemplo: "Uma determinada atividade produtiva possui animais equivalentes a 275.34 U.A.. Essa atividade é realizada em uma área de 450ha. Logo, a carga animal nessa atividade é de 0.61 U.A./ha.",
    conceito:
    ...
    formula:
      "Densidade = nº de cabeças no pasto x 100 / área ocupada",
    formula_equacao: [
      {
...

  {
    ...
    grupo: "3", //Zootecnico
    is_indicador: true,
    exemplo: "Uma determinado propriedade rural iniciou o ciclo produtivo com 194 U.A. no campo. Ao final desse ciclo, existem animais equivalente a 212.34 U.A., caracterizando uma taxa de crescimento do rebanho de 8.19%.",
    conceito:
...

  {
    ...
    formula:
      "G.M.D = (Peso final - Peso Inicial) / nº de dias da avaliação",
    formula_equacao: [
      {
        label: "Peso final",
        name: "pesofinal",
...

  {
    ...
    grupo: "3", // Zootecnicos
    is_indicador: true,
    exemplo: "Em uma determinada propriedade rural existem 100 matrizes em reprodução e 12 touros para realizarem a cobertura das mesmas. Logo, a relação touro/vaca é de 8.33.",
    conceito:
    ...
    formula:
      "Relação Touro/Vaca = nº de matrizes / nº de touros",
    formula_equacao: [
      {
...

  {
    ...
    grupo: "2", //Globais
    is_indicador: true,
    exemplo: "Uma determinada atividade produtiva comercializou 80 cabeças de bois para abate com um peso médio de 460kg cada. A área total ocupada foi de 450ha. Logo, houve a produção de 81,77kg/ha de carne.",
    conceito:
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "A soma de todos os custos fixos relacionados a uma determinada lavoura de soja é de R$ 212.000,00 enquanto a produção foi de 9.000 sacos. Logo, para cada saco de soja produzido, o custo fixo médio foi de R$ 23,55.",
    conceito:
    ...
    formula:
      "Custos Fixos Médio = Custo Fixo Total / Quantidade Produzida",
    formula_equacao: [
      {
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "A soma de todos os custos váriáveis relacionados a uma determinada lavoura de soja foi de R$ 195.000,00 e a respectiva produção foi de 9.000 sacos. Logo, para cada saco de soja produzido, o custo variável médio foi de R$ 21,66.",
    conceito:
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Com a venda dos 5.000 sacos de milho, produzido na safra de 04/05, foram captados R$ 90.500,00. Para todo o desenvolvimento da lavouro em questão foram desembolsados R$ 57.500,00. Logo, a margem bruta dessa atividade produtiva será de R$ 33.000,00.",
    conceito:
    ...
    formula:
      "Margem Bruta = Receita Bruta - Total de Desembolsos",
    formula_equacao: [
      {
        label: "Receita Bruta",
        name: "receitabruta",
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Uma determinada atividade produtiva rendeu R$ 100.000,00 e teve de custos totais R$ 80.000,00 (nesse montante não foram computados os custos de oportunidade do capital próprio nem de terra própria). Nesse caso, a capacidade de investimento é de R$ 20.000, ou seja, o proprietário tem esse valor à sua disposição para a aquisição de novas máquinas, implementação de novas tecnologias, etc.",
    conceito:
    ...
    formula:
      "Capacidade de Investimento = Receita - Custos Totais",
    formula_equacao: [
      {
        label: "Receita",
        name: "receita",
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Para usufluir desse índice é necessário usar o valor de saida desse indicador e colocar no indicador de índice de MC(%).",
    conceito:
    ...
    formula:
      "Margem de Contribuição = Receita Bruta - Custos Variaveis",
    formula_equacao: [
      {
        label: "Receita Bruta",
        name: "receitabruta",
...

  {
    ...
    formula:
      "Índice de MC (%) = Margem de Contribuição / Valor Total de Venda",
    formula_equacao: [
      {
...

  {
    ...
    formula:
      "Balanço de Imobilizado = Imobilizado Final - Imobilizado Inicial",
    formula_equacao: [
      {
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Em uma determinada atividade onde o lucro obtido foi de R$ 9.000,00 e o total de investimento realizado nessa atividade foi de R$ 35.000,00, a taxa de retorno sobre o investimento realizado é de 25%.",
    conceito:
    ...
    formula:
      "RIO(%) = Lucro Operacional * 100 / Investimento Realizado",
    formula_equacao: [
      {
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Um determinado produtor rural investiu R$ 10.500,00 para toda a manutenção e desenvolvimento de um lote de frangos de corte. Essa atividade produtiva teve um ciclo de desenvolvimento de quatro meses e a receita bruta foi de 12.550,00. Logo, o giro do investimento, no período avaliado, foi de 1.19 vezes. ",
    conceito:
    ...
    formula:
      "GI = Valor Total de Vendas / Investimento",
    formula_equacao: [
      {
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Em uma determinada atividade produtiva o valor total do imobilizado utilizado é de R$ 20.000,00. Os custos totais da atividade em questão somam R$ 60.000,00. Logo, o custo de imobilizado representa 33% de toda atividade que está sendo avaliada. ",
    conceito:
  ...
  },
  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Dois trabalhadores rurais são pagos para trabalharem 48 horas semanais, mas trabalham efetivamente apenas 36 horas, porque gastam duas horas por dia com deslocamento até a lavoura. Nesse índice, a eficiência de trabalho da mão-de-obra é de 75%. ",
    conceito:
    ...
    formula:
      "EMO(%) = Horas Trabalhadas * 100 / Horas Pagas",
    formula_equacao: [
      {
  ...
  },
  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Entre a preparação da terra e a última pulverização realizada em uma lavoura de soja, os três tratores utilizados para essas atividades estiveram disponíveis por 900 horas cada um. O trator A foi utilizado 100 horas, o trator B foi utilizado por 210 horas e o trator A foi de 11%, a do trator B foi de 23% e a do trator C foi de 52%.",
    conceito:
    ...
    formula:
      "EOM(%) = Horas Trabalhadas * 100 / Horas Disponíveis",
    formula_equacao: [
      {
        label: "Horas Trabalhadas",
        name: "horastrabalhadas",
  ...
  },
  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Uma determinada atividade produtiva precisou de um montante de capital de R$ 30.000,00 para ser executada. O valor total dos produtos gerados foi de R$ 35.000,00. Logo, a relação custo/benefício dessa atividade foi de 1,16.",
    conceito:
...

  {
    ...
    grupo: "1", // Economicos
    is_indicador: true,
    exemplo: "Se todo o imobilizado da empresa rural é R$ 1.500.000,00 e existem R$ 120.000,00 em dívidas, o patrimônio líquido da enpresa rural é de R$ 1.380.000,00.",
    conceito:
    ...
    formula:
      "Patrimônio Liquido = Patrimônio Bruto - Dívidas Existentes",
    formula_equacao: [
      {
